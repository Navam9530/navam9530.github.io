...
$$x=x_0+ta \implies t=\frac{x-x_0}{a}\\y=y_0+tb \implies y=y_0+(\frac{x-x_0}{a})b \implies y=f(x)\\z=z_0+tc \implies z=z_0+(\frac{x-x_0}{a})c \implies z=g(x)$$
...
$$ax+by+cz=d \implies z=\frac{d-ax-by}{c} \implies z=f(x, y)$$
...
$$\begin{aligned}
x&=h(t)&=at+x_0\\y&=f(x,z)=a_1x+b_1z+c_1=a_1at+a_1x_0+b_1z+c_1&=bt+y_0\\z&=g(x,y)=a_2x+b_2y+c_2=a_2at+a_2x_0+b_2y+c_2&=ct+z_0
\end{aligned}$$
