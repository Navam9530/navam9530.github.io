...
// Exported function will handle absence of search elements gracefully
export function displaySearch() {
  if (!btnSearchTrigger || !btnCancel || !search || !resultWrapper || !input) {
    // search UI removed, nothing to do
    return;
  }
