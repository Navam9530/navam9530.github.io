---
title: Need of Parametric Equations
...
$$\begin{aligned}
ax+by+cz=t & \implies \mathbb{R}^{3} & \implies 3D\\\\
z=f(x,y) & \implies Plane & \implies 2D\\\\
y=g(x,z) & \implies Line & \implies 1D\\\\
x=h(y,z) & \implies Point & \implies 0D
\end{aligned}$$
